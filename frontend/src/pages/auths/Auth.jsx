...
function Auth() {
  ...
  return (
    <div className='h-[100vh] w-[100vw] flex items-center justify-center'>
        <div className='h-[80vh] bg-white border-2 border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2 p-6'>
            <div className='flex flex-col gap-10 items-center justify-center'>
                <div className='flex items-center justify-center flex-col'>
                  <div className='flex items-center justify-center flex-col'>
                    ...
                    <p className='font-medium text-center text-xl'>Fill in the details to get started with the best chat app!</p> 
                  </div>
                  <div className='flex items-center justify-center w-full font-bold text-xl'>
                      <Tabs className='w-full font-bold text-xl ' defaultValue='login'>
                        <TabsList className='bg-transparent rounded-full w-full flex justify-around mt-3'>
                          <TabsTrigger value='login' className='data-[state=active]:bg-blue-200 text-black text-opacity-90 border-b-2 rounded-1xl w-full data-[state=active]:text-black data-[state=active]:font-semibold data-[state=active]:border-b-blue-700 p-3 transition-all duration-300 '> Login</TabsTrigger>
                          <TabsTrigger value='signup' className='data-[state=active]:bg-blue-200 text-black text-opacity-90 border-b-2 rounded-1xl w-full data-[state=active]:text-black data-[state=active]:font-semibold data-[state=active]:border-b-blue-700 p-3 transition-all duration-300 '> Sign Up</TabsTrigger>
                        </TabsList>
