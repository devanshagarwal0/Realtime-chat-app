          ...
          <div className="flex items-center justify-center flex-col">
            <div className="flex items-center justify-center flex-col">
              <div className="flex flex-row items-center justify-center">
                <h1 className="text-5xl font-bold md:text-6xl text-white/90">
                  Welcome
                </h1>
                <img src={victory} alt="Victory Emoji" className="h-[100px]" />
              </div>
              <p className="font-medium text-center text-xl text-white/90">
            ...
            <div className="flex items-center justify-center w-full font-bold text-xl text-white">
              <Tabs className="w-full font-bold text-xl " defaultValue="login">
                <TabsList className="bg-transparent rounded-full w-full flex justify-around mt-3">
                  <TabsTrigger
                    value="login"
                    className="data-[state=active]:bg-blue-800/40 text-white text-opacity-90 border-b-2 rounded-1xl w-full data-[state=active]:text-white data-[state=active]:font-semibold data-[state=active]:border-b-blue-700 p-3 transition-all duration-300 "
                  >
                    {" "}
                    Login
                  </TabsTrigger>
                ...
                >
                  ...
                  ></Input>
                  <Button
                    className="rounded-full p-6 text-xl bg-blue-500 hover:bg-blue-300 transition-all duration-300"
                    onClick={handleLogin}
                  >
                    Login
                  </Button>
